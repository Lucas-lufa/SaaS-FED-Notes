...
<footer class="bg-black text-zinc-500 p-4 mt-8 flex flex-wrap flex-row text-sm">
    <section class="w-1/2 p-8 flex flex-col gap-2">
        <p class="text-zinc-400">&copy; Copyright 2024 Dont Care. All rights reserved.</p>
        <p class="text-xs">
            ...
            by <a href="https://github.com/Lucas-lufa?tab=repositories"
                  class="text-zinc-500 hover:text-white">Lucas Fadersen</a> &
